...
* If any user wants to publish their travelling experience then the user:
    ...
    3. write blogs
    4. add images
    5. If user want to update the blog later ,they can just keep the blog **PRIVATE by selecting private as an option ,or 
    6. To publish the blog user has to select the **PUBLIC option and submit the blog.
...
* We have planned to use highcharts that will show the data in graph form.It is helpful in following ways:
    1. Blogger will know how many blogs he/she has written in what month.(Still deciding on graph parameters)
    2. Users who are willing to read the blogs can see the happening or most visited/suggested backpacking options.
